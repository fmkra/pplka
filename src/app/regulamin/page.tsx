    ...
    <article className="mx-auto max-w-3xl space-y-10 pb-12">
      ...
      <section>
        ...
        <ol className="text-muted-foreground list-inside list-decimal space-y-3">
          ...
          <li>
            Celem serwisu jest pomoc w nauce do egzaminów lotniczych na licencje
            PPL(A), PPL(H), SPL oraz BPL.
          </li>
      ...
      <section>
        ...
        <ol className="text-muted-foreground list-inside list-decimal space-y-3">
          ...
          <li>
            <strong>Dostawca Uwierzytelniania</strong> – podmiot zewnętrzny (np.
            Google w ramach usługi Google OAuth) lub wewnętrzny system
          ...
          <li>
            ...
            zabezpieczona hasłem lub innym sposobem uwierzytelniania wydzielona
            część Serwisu, utworzona po dokonaniu autoryzacji za pośrednictwem
            Dostawcy Uwierzytelniania, w której gromadzone są dane Użytkownika
            oraz informacje o jego działaniach w Serwisie.
          </li>
          <li>
          ...
          <li>
            <strong>Materiały Edukacyjne</strong> – wszelkie treści udostępniane
            w Serwisie i repozytorium{" "}
            <a
          ...
          <li>
            <strong>Treści Użytkownika</strong> – wszelkie treści zamieszczane w
            Serwisie przez Użytkownika, w szczególności komentarze, sugestie
      ...
      <section>
        ...
        <ol className="text-muted-foreground list-inside list-decimal space-y-3">
          <li>
            ...
            Serwis jest udostępnione na licencji GNU General Public License v3.0
            (GPLv3) pod adresem{" "}
            <a
          ...
          <li>
            ...
            Licencji CC BY-NC-ND pod adresem{" "}
            <a
              href="https://github.com/fmkra/pplka-explanations"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <ul className="mt-2 ml-6 list-disc space-y-1">
              <li>
                Użytkownik może kopiować i rozpowszechniać wyjaśnienia jedynie w
                celach niekomercyjnych, pod warunkiem oznaczenia autora (PPLka)
                i bez dokonywania w nich zmian.
              </li>
              <li>
                Zabrania się kopiowania treści serwisu w celach komercyjnych, w
                tym w celu stworzenia płatnego produktu lub serwisu
        ...
        <ol className="text-muted-foreground list-inside list-decimal space-y-3">
          <li>
            ...
            <ol className="mt-2 ml-6 list-inside list-[lower-latin] space-y-1">
              <li>
                Udostępnianiu bazy pytań i materiałów edukacyjnych (dostępne dla
                wszystkich).
              </li>
              <li>
              ...
              <li>Umożliwieniu dodawania komentarzy (wymaga logowania).</li>
            </ol>
          </li>
          <li>
      ...
      <section>
        ...
        <ol className="text-muted-foreground list-inside list-decimal space-y-3">
          ...
          <li>
            Logując się, Użytkownik akceptuje niniejszy Regulamin, w tym wyraża
            zgodę na przetwarzanie przez Serwis danych niezbędnych do obsługi
            Konta, przekazanych przez Dostawcę Uwierzytelniania (w
            szczególności: adres e-mail, imię i nazwisko/nazwa użytkownika oraz
      ...
      <section>
        <h2 className="mb-4 text-xl font-semibold">§ 6. Treści Użytkownika</h2>
        <ol className="text-muted-foreground list-inside list-decimal space-y-3">
          <li>
            Użytkownik, zamieszczając w serwisie jakiekolwiek treści (w
            szczególności komentarze, sugestie wyjaśnień), oświadcza, że posiada
            do nich pełne prawa autorskie.
          </li>
          <li>
            Z chwilą zamieszczenia, Użytkownik udziela Administratorowi
            nieodpłatnej, niewyłącznej, nieograniczonej czasowo i terytorialnie
            licencji na korzystanie z tych treści.
          </li>
          <li>
            ...
            <ol className="mt-2 ml-6 list-[lower-latin] space-y-1">
              ...
              <li>
                Tworzenia opracowań, modyfikacji, skracania i redagowania treści
                (prawa zależne).
              </li>
              <li>
                Wykorzystania treści (w tym ich modyfikacji) do tworzenia
                Materiałów Edukacyjnych udostępnianych na Licencji CC BY-NC-ND.
              </li>
              <li>
          ...
          <li>
            ...
            uzupełnienia Materiałów Edukacyjnych, Administrator zobowiązuje się
            do umieszczenia informacji o autorstwie (np. w sekcji
            &quot;Podziękowania&quot; lub przy danym pytaniu), posługując się
            imieniem i nazwiskiem lub nickiem Użytkownika widocznym w serwisie.
          </li>
        </ol>
      </section>
      ...
      <section>
        ...
        <ol className="text-muted-foreground list-inside list-decimal space-y-3">
          ...
          <li>
            ...
            cookies w swojej przeglądarce internetowej, co może jednak
      ...
      <section>
        ...
        <ol className="text-muted-foreground list-inside list-decimal space-y-3">
          <li>
            Materiały dostępne w serwisie mają charakter wyłącznie edukacyjny i
            pomocniczy.
          </li>
          <li>
      ...
      <section>
        ...
        <ol className="text-muted-foreground list-inside list-decimal space-y-3">
          ...
          <li>
            ...
            Użytkownicy zostaną poinformowani komunikatem na stronie serwisu lub
            mailowo.
          </li>
          <li>
            W sprawach nieuregulowanych niniejszym Regulaminem zastosowanie mają
            przepisy prawa polskiego. Ewentualne spory powinny być rozstrzygane
            polubownie. W przypadku niemożności polubownego rozwiązania sporu,
            sądem właściwym dla rozstrzygnięcia sporu będzie sąd powszechny
            właściwy miejscowo dla siedziby Administratora.
          </li>
        </ol>
      </section>
    </article>
